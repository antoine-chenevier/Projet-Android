...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text = nextActivity.getStringExtra("textATraduire");
        EditText editText =(EditText) findViewById(R.id.editTextTraduire);
    ...
    protected void onResume() {
        ...
        // Use the reload the flag after setting the API key
        super.onResume();
